...
<img src="http://latex.numberempire.com/render?\normal {\phi}_{\iota}\left( \upsilon \right) = \sum_{S\subseteq N\setminus \left\{ \iota \right\}} \frac{\left| S \right|!\left( N - \left| S \right| - 1\right)!}{N!}\left( \upsilon \left( S \cup \left\{ \iota \right\} \right) - \upsilon \left( S \right)\right)" alt="Shap values">
